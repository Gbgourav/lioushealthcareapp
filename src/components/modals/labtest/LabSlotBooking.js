...
import ConfirmTestAppointment from './ConfirmTestAppointment';

const LabSlotBooking = ({appointmentData, closeModal, navigation}) => {
  ...
  const openProfileModal = async slot => {
    setOpenProfile({
      ...
      service_type: appointmentData.service_uid,
